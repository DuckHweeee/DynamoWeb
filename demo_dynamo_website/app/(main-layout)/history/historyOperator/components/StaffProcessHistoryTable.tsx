...
export function StaffProcessHistoryTable({ 
    ...
    const { data: processHistory, loading, error, refetch } = useStaffProcessHistory(
        staffId,
        startDateString,
        endDateString
    )
    ...
    const columns: ColumnDef<DrawingCodeProcessHistory>[] = [
        ...
        },
        {
            ...
            header: () => <div className="font-semibold text-xs">Số Phần</div>,
            cell: ({ row }) => (
        ...
        },
        {
            ...
            header: () => <div className="font-semibold text-xs">Điểm SX</div>,
            cell: ({ row }) => (
                <div className="text-center text-xs">
        ...
        {
            accessorKey: "pgTime",
            header: () => <div className="font-semibold text-xs">PG Time</div>,
            cell: ({ row }) => (
                <div className="text-center text-xs">
        ...
        {
            accessorKey: "processTimeDto.runTime",
            header: () => <div className="font-semibold text-xs">Runtime</div>,
            cell: ({ row }) => {
                const processTime = row.original.processTimeDto
                return (
                    <div className="text-xs">
                        {processTime ? `${processTime.runTime}h` : "N/A"}
                    </div>
                )
            },
            size: 80,
        ...
        {
            accessorKey: "processTimeDto.stopTime",
            header: () => <div className="font-semibold text-xs">Stoptime</div>,
            cell: ({ row }) => {
                const processTime = row.original.processTimeDto
                return (
                    <div className="text-xs">
                        {processTime ? `${processTime.stopTime}h` : "N/A"}
                    </div>
                )
            },
            size: 80,
