...
export default function AddDailyReportForm({ onAdd, onCancel }: AddDailyReportFormProps) {
  const { user } = useAuth();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const adminId = currentAdmin?.id || user?.id || "361f3631-1b80-45d8-a726-834c514dab76";
