...
export default function AddNewGroupKPI({ onAdd, onCancel }: AddGroupKPIFormProps) {
    ...
    const handleInputChange = (field: keyof NewGroupKPI, value: string | number | null) => {
        setNewGroupKPI(prev => ({
            ...prev,
            [field]: value
        }))
    ...
    const selectedGroup = groups.find(group => group.groupId === newGroupKPI.groupId)
