...
export function ReportTimeOperator({ data, type }: ReportTimeOperatorProps) {
            ...
            <div className="my-5 flex gap-3 items-center justify-between">
                ...
                <div className="inline-block rounded-sm bg-white px-6 py-4 shadow-md border w-full">
                    ...
                    <div className="mt-2">
                        ...
                        <p className="text-sm text-gray-400">
                            Trung bình: {data && data.manufacturingPoints > 0
                                ? (data?.manufacturingPoints ?? 0) / data.staffCount
                                : "0"} điểm / người
                        </p>
                    </div>
                </div>
                ...
                <div className="inline-block rounded-sm bg-white px-6 py-4 shadow-md border w-full">
                    ...
                    <div className="mt-2">
                        ...
                        <p className="text-sm text-gray-400">
                            Trung bình: {data && data.processCount > 0
                                ? (data?.processCount ?? 0) / data.staffCount
                                : "0"} nguyên công / người
                        </p>
                    </div>
                </div>
                ...
                <div className="inline-block rounded-sm bg-white px-6 py-4 shadow-md border w-full">
                    ...
                    <div className="mt-2">
                        ...
                        <p className="text-sm text-gray-400">
                            Trung bình: {data && data.totalKpi > 0
                                ? (data?.totalKpi ?? 0) / data.staffCount
                                : "0"} KPI / người
                        </p>
                    </div>
                </div>
