...
//                 <div className="text-lg font-normal">{row.original.startTime}</div>
//                 <div className="text-lg font-normal">{row.original.endTime}</div>
//             </div>
//         ),
//     },
//     {
...
//     title: string
//     dataHistoryProcess: HistoryProcess[]
// }
// export default function TableOperatorDetail({
//     title,
//     dataHistoryProcess,
// }: TableOperatorDetailProps) {
