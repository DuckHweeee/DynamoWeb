                                ...
                                return (
                                    <div key={op.id} className="text-sm border-b-2 pb-2">
                                        <div className="flex items-center gap-2">
                                            <span className={`w-3 h-3 rounded-full bg-${statusColors[st]}`} />
                                            <span className=""><strong>Máy:</strong> {op.machineDto.machineName}</span>
                                        </div>
                                        <div className="ml-5">
                                        ...
                                        <div className="ml-5">
                                            <p className="text-sm">
                                                {(() => {
                                                    const result = getRemainingPgTime(op.startTime, op.pgTime);
                                                    return (
